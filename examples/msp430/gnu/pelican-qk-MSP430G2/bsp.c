...
#define LED1_on()     (P1OUT |= (uint8_t)BIT6)
#define LED1_off()    (P1OUT &= (uint8_t)~BIT6)
...
void BSP_init(void) {
    ...
    P1DIR   |= (BIT0 | BIT6);               /* P1.0 and P1.6 outputs (LEDs) */

    P1DIR  &= ~BIT3;                              /* P1.3 input (Switch S2) */
    P1REN  |=  BIT3;                     /* enable pull-up resistor on P1.3 */
    P1SEL  &= ~BIT3;                         /* enable I/O function on P1.3 */
    P1IES  |=  BIT3;                     /* interrupt edge select high->low */
    P1IFG  &= ~BIT3;                              /* clear interrupt source */
...
void QF_onStartup(void) {
    ...
    P1IE   |= BIT3;                    /* P1.3 interrupt enable (Switch S2) */
}
/*..........................................................................*/
void QK_onIdle(void) {
